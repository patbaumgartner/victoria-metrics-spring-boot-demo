 ...
 * application logs are exported over OTLP. Doing this in code keeps all telemetry
 * configuration in {@code application.yml} and avoids a separate
 * {@code logback-spring.xml} file. Spring Boot's default console appender is left
 * untouched; the OpenTelemetry appender is simply added to the root logger and wired to
 * the Spring-managed {@link OpenTelemetry} instance.
 */
@Component
